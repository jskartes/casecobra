      ...
      <section className="bg-slate-100 py-24">
        ...
        >
          ...
          >
            ...
            >
              What our <span className="relative px-2">customers<Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-green-500" /></span> are saying
            </h2>
          ...
          >
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>&quot;The case feels durable, and I even got a compliment on the design! On my previous case, the image started fading after just a couple weeks. I&apos;ve had the case for two and a half months now, and <span className="p-0.5 bg-slate-800 text-white">the image is still super clear</span>. Love it!&quot;</p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>&quot;I usually keep my phone together with my keys in my pocket, and that led to some pretty heavy scratch marks on all of my last phone cases. Besides a barely-noticeable scratch on the corner, this one <span className="p-0.5 bg-slate-800 text-white">still looks brand new after half a year</span>. I dig it.&quot;</p>
              </div>
              <div className="flex gap-4 mt-2">
                <img
                  className="rounded-full h-12 w-12 object-cover"

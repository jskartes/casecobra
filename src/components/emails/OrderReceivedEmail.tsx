...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    ...
    "http://localhost:3000" :
    "https://casecobra-opal-delta.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We&apos;re preparing everything for delivery, and we&apos;ll notify you once your package has been shipped. Delivery usually takes 2 days.
            </Text>
